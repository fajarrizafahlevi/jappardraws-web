export default function about() {
  return (
    <section className="mx-auto max-w-5xl min-h-screen pb-0">
      <h2>About me</h2>
      <p>
        It all started in mid-2017 when my internship got delayed to October. Since there
        weren&apos;t many things to do, I thought of spending my holiday learning more about
        drawing. I came across a YouTuber called Ross Draws, which inspired me to start my art
        journey.
        <br />
        <br />
